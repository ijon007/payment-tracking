...
import { Calendar as CalendarIcon, CaretDown } from "@phosphor-icons/react";
...
export function EditableContractPreview({
  ...
  const formatDateForContract = (date: Date | undefined) => {
    if (!date) return "";
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <p>
                ...
                <Input
                  className="inline-block h-auto w-64 border-b border-dashed border-black bg-transparent p-0 text-center focus-visible:ring-0 focus-visible:border-solid"
                  onChange={(e) => onCompanyRepresentativesChange?.(e.target.value)}
                  placeholder="Johan Gjinko dhe Ijon Kushta"
              ...
              <p>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger
                    render={
                      <Button
                        className="inline h-auto border-b border-dashed border-black bg-transparent p-0 font-medium text-black hover:bg-transparent hover:text-black"
                        variant="ghost"
                      >
                        {selectedClient?.name || "_______________"}
                ...
                , me adresë në{" "}
                <Input
                  className="inline-block h-auto w-48 border-b border-dashed border-black bg-transparent p-0 text-center focus-visible:ring-0 focus-visible:border-solid"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <p>
                ...
                <Input
                  className="inline-block h-auto w-32 border-b border-dashed border-black bg-transparent p-0 text-center font-medium focus-visible:ring-0 focus-visible:border-solid"
                ...
                <Popover>
                  <PopoverTrigger
                    render={
                      <Button
                        className={cn(
                          "inline h-auto border-b border-dashed border-black bg-transparent p-0 font-normal text-black hover:bg-transparent hover:text-black",
                          !startDate && "text-muted-foreground"
                        )}
                        variant="ghost"
                      >
                        {startDate ? formatDateForContract(startDate) : "___ / ___ / 2025"}
                      </Button>
                    }
                  />
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                <Input
                  className="inline-block h-auto w-32 border-b border-dashed border-black bg-transparent p-0 text-center focus-visible:ring-0 focus-visible:border-solid"
                  onBlur={handleMaintenanceCostBlur}
